                ...
                >
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                <!-- v-if y v-else solo funcionan siempre y cuando esten en elementos consecutivos
                                primero v-if y el siguiente elemento v-else-->

                                <table class="w-100 table">
                                    <thead>
                                        <tr>
                                            <!-- cuando estamos en template no es necesario usar 'props.'
                                            esta se usa cuando estamos en la parte del script  -->
                                            <th>Imagen</th>
                                            <th>Nombre</th>
                                            <th>Precio</th>
                                            <th>Cantidad</th>
                                    ...
                                    <tbody>
                                        <tr v-for="producto in carrito">
                                            <td>
                                                <!-- : indica si es o no un atributo dinamico -->
